...
ActiveRecord::Schema.define(version: 2024_09_05_165832) do
  ...
  create_table "companies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.decimal "total_reimbursements", precision: 10
  ...
  create_table "reimbursement_claims", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "purpose"
